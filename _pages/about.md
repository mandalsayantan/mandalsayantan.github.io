...
A related research interest, currently being planned, focuses on the philosophy of aesthetics by studying the representational primitives of rhythm, or _Vrittam_ in Paninian terms. This project will seek to explore the hypothesis that representation of rhythm is shared between language and music (melodic renditions poetry), and that it emerges out of autocorrelational patterns in the recurrences of syllable-based meters (_Chandas_). The project will seek to identify universal trends in such autocorrelational patterns in musical renditions of poetry across a range of different languages and then proceed to identify and isolate specialized neurological maps and neurophysiological events that display selective preferences for the same.This project will seek to contribute to the emerging discipline of _Empirical Aesthetics_ attempting to elevate the notion of aesthetics from subjective judgments to objectively quantifiable formal-logical representational states and neurocomputational events.
